file://<WORKSPACE>/day1/day1.scala
### java.lang.AssertionError: assertion failed: position error, parent span does not contain child span
parent      =  extends CommandLineParser.FromString[Array[String]] {
  def fromString(s: String): Array[String] = _root_.scala.Predef.???
} # -1,
parent span = <62..155>,
child       = def fromString(s: String): Array[String] = _root_.scala.Predef.??? # -1,
child span  = [113..117..156]
...
action parameters:
uri: file://<WORKSPACE>/day1/day1.scala
text:
```scala
...
def splitColumn(input: String): List[Int] = {
    input.split("\n").map(_.split("\\s+").map(_.toInt).sum).toList
}


@main
def main(args: Array[String]): Unit = {
    val result = splitColumn(example)
    println(result)
}
